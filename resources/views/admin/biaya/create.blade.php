    ...
    <div class="px-4 py-8">
        ...
        <form action="{{ route('admin.biaya.store') }}" method="POST" class="mt-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama_biaya" name="nama_biaya" class="w-full p-2 border border-gray-300 rounded mt-1" required>
                @error('nama_biaya')
            ...
            <div class="mb-4">
                ...
                <input type="number" id="jumlah" name="jumlah" class="w-full p-2 border border-gray-300 rounded mt-1" required>
                @error('jumlah')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="jumlah_non" name="jumlah_non" class="w-full p-2 border border-gray-300 rounded mt-1" required>
                @error('jumlah_non')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
