...
@section('content')
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg mb-6">
            <h2 class="text-2xl font-semibold text-blue-600 mb-4">Statistik Pendaftar Berdasarkan Jurusan dan Jenis Kelamin
            </h2>
            <canvas id="pendaftarChart" width="400" height="200"></canvas>
        </div>

        <!-- Search and Export Section -->
        <div class="mb-6 flex flex-col gap-2 sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <!-- Input Live Search -->
            <input type="text" id="search" class="border px-4 py-2 rounded-lg w-full sm:w-1/3"
                placeholder="Cari data pendaftar...">

            <!-- Tombol Export -->
            <div class="flex space-x-4">
                <a href="{{ route('admin.pendaftaran.exportExcel') }}"
                    class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-105 ">
                    Export Excel
                </a>
